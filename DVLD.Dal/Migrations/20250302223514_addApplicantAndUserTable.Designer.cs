...
namespace DVLD.Dal.Migrations
{
    ...
    [Migration("20250302223514_addApplicantAndUserTable")]
    partial class addApplicantAndUserTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DVLD.Core.Models.Applicant", b =>
                {
                    b.HasOne("DVLD.Core.Models.Country", null)
                        .WithMany("Applicants")
                        .HasForeignKey("CountryID");

                    b.HasOne("DVLD.Core.Models.Country", "NationalityCountry")
                        .WithMany()
